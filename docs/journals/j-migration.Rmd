...
10. OK, simplifying the Vietnam map, suing `rgeos::gSimplify` - careful, this removes the dataframe, you need to keep it and add it back. ARGH, but unions have to happen before simplifying... 
