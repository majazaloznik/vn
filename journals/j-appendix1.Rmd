...
2. data-sources are dictionaries, manuals, questionnaires etc. explaining data/raw stuff. 

3. docs are reports, papers, presentations produced based on results, figs and scripts. 
...
5. journals - a bit late, but there are a few. i guess they can be here, otherwise maybe just a single file at the top. .Rmd file seems reasonable? 
...
* and there could be funcitons that are used across projects/reports. 
